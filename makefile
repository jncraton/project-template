...
$(SRC).pdf: $(SRC).md
	pandoc --toc --variable documentclass=extarticle --variable fontsize=12pt --variable mainfont="FreeSans" --variable mathfont="FreeMono" --variable monofont="FreeMono"  --mathjax --latex-engine=xelatex -s -o $@ $< 
